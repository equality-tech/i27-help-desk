...
NOTIFICATION_SERVICE_URL = os.getenv("NOTIFICATION_SERVICE_URL", "http://localhost:8084/notifications/event")
TICKET_SERVICE_URL = os.getenv("TICKET_SERVICE_URL","http://localhost:8082/tickets")
